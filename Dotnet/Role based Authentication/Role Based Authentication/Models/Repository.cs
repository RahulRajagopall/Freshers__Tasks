...
namespace RoleBasedAuthentication.Models{
    ...
    public class Repository{
        public static bool login(User user){
            ...
            sqlcommand.Parameters.Add("@username",sqlDbType:SqlDbType.VarChar).Value = user.Username;
            sqlcommand.Parameters.Add("@password",sqlDbType:SqlDbType.VarChar).Value = user.Password;
